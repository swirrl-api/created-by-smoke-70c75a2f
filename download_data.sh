...
# =======================================================
NOTEBOOK_URL=http://swirrl.rdwd.acc.knmi.cloud/swirrl/jupyter/026025d3-8189-4867-8b9b-bc4c2a5e3274
SERVICE_ID=026025d3-8189-4867-8b9b-bc4c2a5e3274
get_notebook http://swirrl.rdwd.acc.knmi.cloud/swirrl-api/v1.0/notebook 3046b767-d463-4d50-9af2-2eda3cef77c3 026025d3-8189-4867-8b9b-bc4c2a5e3274
echo 'Nothing to download from data staging directory.'
download_working_dir_data ${NOTEBOOK_URL}/api/contents
delete_notebook http://swirrl.rdwd.acc.knmi.cloud/swirrl-api/v1.0/notebook
